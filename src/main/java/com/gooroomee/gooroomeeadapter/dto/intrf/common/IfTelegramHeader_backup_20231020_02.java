...
@Setter
@ToString
public class IfTelegramHeader_backup_20231020_02 {
	...
	/** 메시지 목록 건수 */
	private int msgeListCont = 0;
	
	/** 메시지 목록 */
	private List<IfTelegramHeaderResponseMessage> msgeList = new ArrayList<>();
